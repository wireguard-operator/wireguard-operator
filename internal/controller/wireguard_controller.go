...
// +kubebuilder:rbac:groups=wireguard-operator.io,resources=wireguards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=wireguard-operator.io,resources=wireguards/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=wireguard-operator.io,resources=wireguards/finalizers,verbs=update
...
func (r *WireGuardReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&wireguardoperatoriov1alpha1.WireGuard{}).
		Named("wireguard").
		Complete(r)
}
