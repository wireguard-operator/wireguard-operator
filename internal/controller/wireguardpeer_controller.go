...
// +kubebuilder:rbac:groups=wireguard-operator.io,resources=wireguardpeers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=wireguard-operator.io,resources=wireguardpeers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=wireguard-operator.io,resources=wireguardpeers/finalizers,verbs=update
...
func (r *WireGuardPeerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&wireguardoperatoriov1alpha1.WireGuardPeer{}).
		Named("wireguardpeer").
		Complete(r)
}
