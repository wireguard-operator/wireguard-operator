...
var _ = Describe("WireGuard Webhook", func() {
	var (
		obj       *wireguardoperatoriov1alpha1.WireGuard
		oldObj    *wireguardoperatoriov1alpha1.WireGuard
	...
	Context("When creating or updating WireGuard under Validating Webhook", func() {
