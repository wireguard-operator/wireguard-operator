...
// WireGuardTrafficFlowSpec defines the desired state of WireGuardTrafficFlow.
type WireGuardTrafficFlowSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of WireGuardTrafficFlow. Edit wireguardtrafficflow_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// WireGuardTrafficFlowStatus defines the observed state of WireGuardTrafficFlow.
...
// WireGuardTrafficFlow is the Schema for the wireguardtrafficflows API.
